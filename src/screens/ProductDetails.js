        ...
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <View style={{ flex: 0.8, flexDirection: 'row' }}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', paddingLeft: 10 }}>
                    ...
                    <Text style={{ fontWeight: 'bold', fontSize: 13, paddingLeft: 5 }}>Price : {route.params.prdPrice}</Text>
                    <Text style={{ fontSize: 13, color: '#888', fontWeight: 'bold', paddingLeft: 5 }}>Discount : {route.params.prdDiscount}</Text>
                    <TouchableOpacity style={{ backgroundColor: 'orange', width: 90, height: 30, borderRadius: 5, marginTop: 20, marginLeft: 80 }}>
            ...
            <View style={{ flex: 2, }}>
                ...
                <Text style={{ paddingHorizontal: 10, fontSize: 12, color: '#999', }}>{route.params.prdDescription}</Text>
            </View>
